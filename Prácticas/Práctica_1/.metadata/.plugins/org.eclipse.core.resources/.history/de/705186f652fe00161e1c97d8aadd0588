...
import observador.PrevisionTiempo;
...
public class GUI extends JFrame {
	...
	static PrevisionTiempo prevision = new PrevisionTiempo();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Temperatura mínima :");
        jPanel2.add(jLabel1);
        ...
        jLabel4.setText("Previsión para Hoy:       ");
        jPanel3.add(jLabel4);
	...
	/**
	 * Cambia el rango de temperaturas que generará el Sensor de temperatura
	 * @param evt
	 */
	...
	/**
	 * Actualiza los valores de los campos en la interfaz gráfica
	 * @param temp tengo a poner en la interfaz gráfica
	 */
	...
	/**
	 * Actualiza la previsión del tiempo de hoy.
	 * @param tiempo :String que indica la previsión para hoy
	 */
